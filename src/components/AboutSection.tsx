        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-lg leading-relaxed">
              <p>
                At PITSA, we believe in the magic of authentic woodfire cooking. Our journey began with a simple passion: 
                creating the perfect pizza using time-honored techniques and the freshest ingredients.
              </p>
              <p>
                Every pizza is hand-crafted in our traditional woodfire oven, where temperatures reach the perfect heat 
                to create that distinctive crispy crust and smoky flavor that makes our pizzas truly special.
              </p>
              <p>
                From our classic Margherita to our signature Chicken Tikka Pizza, each dish tells a story of 
                authentic flavors, fresh ingredients, and passionate craftsmanship.
              </p>
            </div>
          ...
          <div className="relative">
            <div className="relative bg-gradient-to-br from-pizza-cream to-pizza-orange/20 rounded-3xl p-8 h-96">
              ...
              <div className="absolute top-6 right-6 w-16 h-16 bg-pizza-red/20 rounded-full flex items-center justify-center">
                <svg className="w-8 h-8 text-pizza-red" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="absolute bottom-6 left-6 w-20 h-20 bg-pizza-gold/30 rounded-full flex items-center justify-center">
                <svg className="w-10 h-10 text-pizza-warm" fill="currentColor" viewBox="0 0 24 24">
